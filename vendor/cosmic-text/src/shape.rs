...
fn shape_fallback(
    ...
    for (info, pos) in glyph_infos.iter().zip(glyph_positions.iter()) {
        ...
        glyphs.push(ShapeGlyph {
            ...
            font_variation_hash: attrs.font_variations.hash64(),
...
impl ShapeGlyph {
    const fn layout(
        ...
        LayoutGlyph {
            ...
            font_variation_hash: self.font_variation_hash,
    ...
    pub fn build(
        ...
        if any_decoration {
            ...
            let primary_metrics = self
                ...
                .and_then(|glyph| {
                    font_system
                        .get_font_by_variation_hash(
                            glyph.font_id,
                            glyph.font_weight,
                            glyph.font_variation_hash,
                        )
