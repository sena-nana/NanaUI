...
component_catalog! {
    ...
    PROGRESS => { id: "progress", name: "Progress", family: Feedback, migration: Compatibility, feature: Some("feedback"), compiled: cfg!(feature = "feedback"), capabilities: [Render, Accessibility] },
