...
pub use components::{
    ...
    TextContent, TextDiagnosticMark, TextDiagnosticSeverity, TextDiagnosticSpan, TextFoldGeometry,
    TextFoldGutter, TextFoldMark, TextFoldMarker, TextHorizontalAlignment, TextHover,
    TextHoverPopup, TextInputPresentation, TextInputState, TextMatchMark, TextMatchMarker,
    TextMatchSpan, TextMetrics, TextOverlayMetrics, TextSelection, TextShapeConstraints,
    TextShaper, TextShaping, TextSnippet, TextSnippetSession, TextVerticalAlignment, TooltipVisual,
};
pub use dock::{
