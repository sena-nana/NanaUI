...
| ---: | ---: | ---: | ---: | ---: | ---: |
| 250 | 9.4 KB | 0.008 → 0.003 ms | 0.035 → 0.012 ms | 0.002 → 0.009 ms | 0.013 → 0.011 ms |
| 1,000 | 37.9 KB | 0.021 → 0.010 ms | 0.105 → 0.037 ms | 0.006 → 0.014 ms | 0.035 → 0.027 ms |
| 4,000 | 154.9 KB | 0.081 → 0.030 ms | 0.388 → 0.119 ms | 0.019 → 0.032 ms | 0.113 → 0.093 ms |
| 8,000 | 310.9 KB | 0.166 → 0.072 ms | 0.762 → 0.224 ms | 0.036 → 0.054 ms | 0.222 → 0.172 ms |

310 KB 文档上一次按键从 0.93 ms 降到 0.30 ms。`caret input` 变大是这一轮同时接入的**视觉序
