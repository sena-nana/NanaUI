...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `reactive` 每事件 | 8.872 | 6.660 | 6.038 | 4.783 | **3.85** | **−57%** |
| 　其中 settle | 2.664 | 1.638 | 1.330 | 0.732 | **0.409** | **−85%** |
| `reactive-components` 每事件 | 5.449 | 3.388 | 2.751 | 1.793 | **1.04** | **−81%** |
| 　其中 settle | 2.485 | 1.537 | 1.248 | 0.623 | **0.331** | **−87%** |

第五轮的同机对照是 `reactive` 每事件 4.96 → 3.85、settle 0.763 → 0.409（前四轮那几列记在
